...
import { DataTableViewOptions } from "@/app/(main)/dashboard/products/table/data-table-view-options"

// import { priorities, statuses } from "../data/data" 
import { الفئة, الحالة } from "@/app/(main)/dashboard/products/table/filter-data"
