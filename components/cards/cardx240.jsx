...
export default function Cardx240({ article, getBase64, category }) {
  const editThumbRes = editThumb(article, 480, false, false)
  ...
  return (
    ...
    >
      <Link href={`/news/${updatedArticle.slug}`} className="overflow-hidden">
        <Image
          unoptimized
          className="relative z-0 box-content h-[180px] w-[360px] rounded-xl object-cover lg:h-[200px] lg:w-[250px]" // h-[280px] w-full
          src={imgSrc}
        ...
        <div className="my-2 text-right">
          <div className="pr-0">
            <h3 className="mb-0 pl-[1px] text-[17px] font-semibold md:text-[17px]">
