export const BottomNavbar = () => {
  ...
  return (
    ...
    <div className="sticky bottom-0 flex bg-white z-50 w-full border-t p-1 h-10 text-center justify-center items-center">
      <p className="text-black">شكرا لإستخدامك موقع مصر-الان Msrnow.com</p>
      {/* {arr.map((a, i) => (
