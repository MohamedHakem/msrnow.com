...
//         right:
//           'inset-y-0 right-0 h-full w-4/4  border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right tablet:max-w-[50%] laptop:max-w-[25%]'
//       }
//     },
//     defaultVariants: {
//       side: 'right'
...
//         ref={ref}
//         dir="rtl"
//         className={cn(sheetVariants({ side }), className, 'flex flex-col justify-between')}
//         {...props}
//       >
//         {children}
//         <SheetPrimitive.Close
//           className="relative rounded-sm opacity-80 w-[97%] border m-1 p-4 ring-offset-background
...
//             <X  className="h-8 w-8" />
//             <span className="text-lg font-semibold">إغلاق</span>
//           </div>
