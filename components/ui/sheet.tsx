  ...
  "fixed z-50 scale-100 gap-4 bg-white p-6 opacity-100 dark:bg-slate-900",
  {
    variants: {
      position: {
        ...
        bottom: "animate-in slide-in-from-bottom w-full duration-400",
        left: "animate-in slide-in-from-right h-full duration-300", // rtl => left: => slide-in-from-right
        right: "animate-in slide-in-from-left h-full duration-300", // rtl => right: => slide-in-from-left
      },
      size: {
        content: "",
        default: "",
