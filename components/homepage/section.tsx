            ...
            <div className="flex flex-col gap-2">
              {categoryInEnglish === 'egypt' ? (
                <div className="p-3 border rounded-xl">
                  <ul className="flex flex-row justify-between">
                    <li className="p-2 border rounded-xl hover:bg-gray-50 active:scale-95 transition-all duration-200 ease-in-out">
                      <Link href={`/news/${categoryInEnglish}`} className="flex flex-row gap-3 md:gap-4 w-full">
                        أهم أخبار مصر
                        <ChevronLeft />
                      </Link>
                    </li>
              ...
              <div className="">
                <Link href={`/news/${categoryInEnglish}`}>
                  <div
                    className="flex flex-row justify-between items-center p-10 py-4 border rounded-xl text-xl hover:bg-gray-50 
